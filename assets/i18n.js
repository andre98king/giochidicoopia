...
const TRANSLATIONS = {
  it: {
    ...
    privacy_p8: "Allo stato attuale, i link store visibili sul sito sono link diretti e non risultano corredati da tracciamento affiliato proprietario di Coophubs.",
    privacy_h6: "6. Controllo da parte dell'utente",
  ...
  en: {
    ...
    privacy_p8: "At the moment, store links shown on the site are direct links and do not appear to include proprietary affiliate tracking by Coophubs.",
    privacy_h6: "6. User control",
